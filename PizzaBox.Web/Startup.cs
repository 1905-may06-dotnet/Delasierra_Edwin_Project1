...
namespace PizzaBox.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<PizzaBox.Data.Model.PizzaContext>(optionsAction =>
            ...
            services.AddScoped<IOrderRepository, UserRepository>();
            services.AddScoped<ILocationRepository, UserRepository>();
